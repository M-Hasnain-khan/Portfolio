...
Sent from Portfolio Contact Form`)
  ...
  // Gmail compose URL with pre-filled content
...
[Your Name]`)
  ...
  return (
    <section id="contact" ref={contactRef} className="relative min-h-screen bg-white py-20 overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-50/50 via-white to-green-50/50" />

      {/* Floating Background Shapes */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-r from-emerald-100 to-green-100 rounded-full blur-3xl opacity-30" />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-r from-green-100 to-emerald-100 rounded-full blur-3xl opacity-25" />
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-emerald-200 to-green-200 rounded-full blur-2xl opacity-20" />
      ...
      >
        ...
        <motion.div className="text-center mb-16" variants={itemVariants}>
          ...
          <motion.div
            className="w-32 h-1 bg-gradient-to-r from-emerald-500 to-green-500 mx-auto rounded-full mb-6"
            initial={{ width: 0 }}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 max-w-7xl mx-auto">
          ...
          <motion.div className="space-y-8" variants={itemVariants} transition={{ delay: 0.3 }}>
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <motion.a
                    ...
                    className="flex items-center space-x-4 p-4 bg-white rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer group hover:scale-105"
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-bold text-gray-800 group-hover:text-emerald-700 transition-colors duration-300">
                        {info.title}
                      </h4>
                ...
                <div className="flex space-x-4">
                  {socialLinks.map((social, index) => (
                    <motion.a
                      ...
                      className="w-12 h-12 rounded-xl flex items-center justify-center bg-white shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer group"
            ...
            >
              <div className="bg-white rounded-2xl p-6 text-center shadow-lg border border-emerald-100 hover:shadow-xl transition-all duration-300 cursor-pointer hover:scale-105">
          ...
          >
            <motion.div className="flex items-center mb-8" variants={inputVariants}>
              <HiSparkles className="text-emerald-600 text-2xl mr-3" />
              <h3 className="text-3xl font-bold text-gray-900">Send Message</h3>
            </motion.div>

            {isSubmitted && (
              <motion.div
                className="bg-green-50 border border-green-200 rounded-2xl p-4 mb-6 flex items-center"
              ...
              >
                ...
                <div>
                  <h4 className="font-bold text-green-800">Email Client Opened!</h4>
            ...
            {submitError && (
              ...
              >
                ...
                <div>
                  <h4 className="font-bold text-red-800">Unable to Open Email Client</h4>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <motion.div variants={inputVariants}>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-300 cursor-pointer ${
              ...
              <motion.div variants={inputVariants}>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows="6"
                  className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-300 resize-none cursor-pointer ${
              ...
              <motion.button
                ...
                className="w-full bg-gradient-to-r from-emerald-600 to-green-600 text-white py-4 px-8 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer hover:scale-105"
            ...
            <motion.div className="mt-8 pt-6 border-t border-gray-200 text-center" variants={inputVariants}>
              <p className="text-gray-600">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-emerald-600 font-semibold hover:text-emerald-700 transition-colors duration-300 cursor-pointer underline"
                >
                  mohsinlegend3@gmail.com
                </a>
              </p>
              <p className="text-sm text-gray-500 mt-2">Click to compose email directly in Gmail</p>
            </motion.div>
          </motion.div>
        </div>
        ...
        >
          <div className="bg-gradient-to-r from-emerald-600 to-green-600 rounded-3xl p-8 text-white shadow-2xl relative overflow-hidden max-w-4xl mx-auto">
            ...
            <div className="relative z-10">
              <h3 className="text-3xl sm:text-4xl font-bold mb-4">Ready to Start Something Great?</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white text-emerald-600 px-8 py-4 rounded-2xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 cursor-pointer inline-flex items-center justify-center"
                >
                  <HiSparkles className="inline mr-2" />
                  Start Project
                </a>
                <button className="border-2 border-white text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white/10 transition-all duration-300 hover:scale-105 cursor-pointer">
                  Download Resume
                </button>
              </div>
            </div>
