...
//ASSETS
import Hasnain from "@/assets/hasnain.jpeg"
...
const HeroSection = () => {
    ...
    return (
        <section id="herosection" className="relative min-h-screen bg-gradient-to-br from-emerald-50 via-white to-green-50 overflow-hidden flex items-center justify-center">
            {/* Enhanced Background */}
            ...
            >
                ...
                <div className="text-center lg:text-left lg:w-1/2 space-y-6 lg:space-y-8">
                    <motion.div variants={itemVariants}>
                        ...
                        >
                            Hi, I'm{" "}
                            <span className="text-emerald-600 inline-flex items-center whitespace-nowrap">
                                M-Hasna
                    ...
                    >
                        <motion.a
                            href="#contact"
                            className="bg-gradient-to-r from-emerald-600 to-green-600 text-white px-8 py-4 rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-100"
                        ...
                        <motion.a
                            href="#projects"
                            className="border-2 border-emerald-600 text-emerald-600 px-8 py-4 rounded-full font-semibold text-lg hover:bg-emerald-600 hover:text-white transition-all duration-100 shadow-lg hover:shadow-xl"
                            variants={buttonVariants}
                            whileHover="hover"
                            whileTap="tap"
                        >
