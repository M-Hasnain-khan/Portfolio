...
const AboutSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute w-96 h-96 bg-gradient-to-r from-emerald-200 to-green-200 rounded-full blur-3xl top-10 right-10 opacity-30" />
      <div className="absolute w-80 h-80 bg-gradient-to-r from-green-300 to-emerald-300 rounded-full blur-2xl bottom-20 left-10 opacity-25" />  
      ...
      {traits.map((t, i) => (
        ...
        >
          <div
            className="w-20 h-20 rounded-full flex items-center justify-center shadow-lg cursor-pointer backdrop-blur-sm border border-white/20"
            style={{ backgroundColor: `${t.color}15` }}
          >
            <t.icon className="text-2xl" style={{ color: t.color }} />
          </div>
      ...
      >
        ...
        <motion.div className="text-center mb-16" variants={itemVariants}>
          ...
          <motion.div
            className="w-24 h-1 bg-gradient-to-r from-emerald-500 to-green-500 mx-auto rounded-full"
            initial={{ width: 0 }}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 mb-24">
          {/* Left: Story */}
          <motion.div
            className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-emerald-100 space-y-6"
          ...
          >
            ...
            <motion.div
              className="bg-gradient-to-r from-emerald-500 to-green-500 text-white p-6 rounded-2xl relative overflow-hidden"
            ...
            >
              ...
              <p className="mt-2 text-emerald-100">Let's connect and bring ideas to reality together.</p>
            </motion.div>
          </motion.div>
          ...
          <motion.div className="space-y-8" variants={itemVariants}>
            <motion.div
              className="bg-gray-900 rounded-2xl p-6 font-mono text-sm relative overflow-hidden"
            ...
            <div className="grid grid-cols-2 gap-4">
              <motion.div
                className="bg-white/80 p-6 rounded-2xl text-center shadow-lg border border-emerald-100"
        ...
        {/* Timeline */}
        <motion.div className="mb-24 relative" variants={itemVariants}>
          <h3 className="text-3xl font-bold text-center text-gray-900 mb-12">
            My <span className="text-emerald-600">Journey</span>
          </h3>
          <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-emerald-500 to-green-500 rounded-full"></div>
            ...
            {journey.map((s, i) => (
              ...
              >
                <div className={`w-5/12 ${i % 2 === 0 ? "text-right pr-8" : "text-left pl-8"}`}>
                  <div className="bg-white/80 p-6 rounded-2xl shadow-lg border border-emerald-100">
                    <div className="text-2xl font-bold text-gray-900 mb-2">{s.year}</div>
                    <div className="text-xl font-semibold text-emerald-600 mb-2">{s.title}</div>
        ...
        <motion.div className="text-center" variants={itemVariants}>
          <motion.div
            className="bg-gradient-to-r from-emerald-600 to-green-600 text-white p-8 rounded-3xl shadow-2xl relative overflow-hidden"
            whileHover={{
              scale: 1.02,
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-2xl sm:text-3xl font-bold mb-4">Let's Create Something Amazing!</h3>
